        ...
        <div className="container">
          ...
          <div className="row center">
            <h5 className="header col s12 light">
              Studi Kasus antrian diambil dari Tempat Pencucian Motor BaronWash. Dta pengamatan dilakukan dalam dua hari
              diambil di hari Jumat 19 April 2019 dan Sabtu 20 April 2019 pada segmen waktu 13.00-15.00.
            </h5>
          </div>
          <div className="row center">
